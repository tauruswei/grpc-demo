...
var file_gym_proto_rawDesc = []byte{
	...
	0x7c, 0x0a, 0x03, 0x47, 0x79, 0x6d, 0x12, 0x39, 0x0a, 0x0c, 0x42, 0x6f, 0x64, 0x79, 0x42, 0x75,
	...
	0x00, 0x12, 0x3a, 0x0a, 0x0d, 0x42, 0x6f, 0x64, 0x79, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x69, 0x6e,
	0x67, 0x31, 0x12, 0x13, 0x2e, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74,
	0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x1a, 0x12, 0x2e, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x77,
	0x65, 0x69, 0x67, 0x68, 0x74, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0e, 0x5a,
	0x0c, 0x2f, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x62, 0x06, 0x70,
...
var file_gym_proto_depIdxs = []int32{
	...
	0, // 1: lightweight.Gym.BodyBuilding1:input_type -> lightweight.Person
	1, // 2: lightweight.Gym.BodyBuilding:output_type -> lightweight.Reply
	1, // 3: lightweight.Gym.BodyBuilding1:output_type -> lightweight.Reply
...
type GymClient interface {
	...
	BodyBuilding1(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Reply, error)
}
...
func (c *gymClient) BodyBuilding1(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/lightweight.Gym/BodyBuilding1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GymServer interface {
	...
	BodyBuilding1(context.Context, *Person) (*Reply, error)
}
...
func (*UnimplementedGymServer) BodyBuilding1(context.Context, *Person) (*Reply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BodyBuilding1 not implemented")
}
...
func _Gym_BodyBuilding1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Person)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GymServer).BodyBuilding1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lightweight.Gym/BodyBuilding1",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GymServer).BodyBuilding1(ctx, req.(*Person))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Gym_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BodyBuilding1",
			Handler:    _Gym_BodyBuilding1_Handler,
		},
	},
